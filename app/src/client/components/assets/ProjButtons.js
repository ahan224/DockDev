...
const ProjButtons = ({ start, stop, restart, remove }) => (
  <div className="btn-group btn-group-sm container-controls" role="group" aria-label="Container Controls">
    <button type="button" className="btn btn-secondary btn-info-outline">Stop</button>
    <button type="button" className="btn btn-secondary btn-info-outline">Play</button>
    <button type="button" className="btn btn-secondary btn-info-outline">Restart</button>
  </div>
