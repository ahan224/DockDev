...
const ProjectNav = ({ projects, addContainer, delContainer, manageProjects, children, params, context }) => (
  <div id="content">
    ...
    {React.cloneElement(children, { projects, addContainer, context, delContainer, manageProjects })}
  </div>
);
